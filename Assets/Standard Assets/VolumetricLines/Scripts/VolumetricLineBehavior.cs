...
namespace VolumetricLines
{
	...
	public class VolumetricLineBehavior : MonoBehaviour 
	{
		...
		void Start () 
		{
			...
			GetComponent<MeshRenderer>().material = GetComponent<Renderer>().material;
			if (SetLinePropertiesAtStart)
			{
				GetComponent<MeshRenderer>().sharedMaterial.color = m_lineColor;
				GetComponent<MeshRenderer>().sharedMaterial.SetFloat("_LineWidth", m_lineWidth);
			}
			else
			{
				m_lineColor = GetComponent<MeshRenderer>().sharedMaterial.color;
				m_lineWidth = GetComponent<MeshRenderer>().sharedMaterial.GetFloat("_LineWidth");
			}
		...
		void Update()
		{
			...
			{
				GetComponent<MeshRenderer>().sharedMaterial.SetFloat("_LineScale", transform.GetGlobalUniformScaleForLineWidth());
			}
        ...
        public void UpdateLineWidth(float width) {
            GetComponent<MeshRenderer>().sharedMaterial.SetFloat("_LineWidth", width);
        }
